...
We show that if one can directly estimate choice probabilities, several tractable approaches produce estimates of structural parameters without repeatedly solving the model. These include @Hotz1993, @AgMira2002, @Aguirregabiria2007, @Pesendorfer2008, and @Arcidiacono2011. @MagnacThesmar discuss identification of this class of models.
...
Here is the proposed timeline of due dates. Submissions **must** be made through Canvas as a notebook (e.g. jupyter or quarto) formatted to html or pdf with printed output. You can submit mathematical and programming questions separately if you wish.

| Assignment | Due Date |
| ---------- | -------- |
| Assignment 1 | November 7 |
| Assignment 2 | November 14 | 
| Assignment 3 | November 21 | 
| Assignment 4 | November 28 | 
| Assignment 5 | December 5 | 
| Assignment 6 | December 12 | 
