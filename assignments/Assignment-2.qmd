...
Let $\sigma_{H}$ be the dispersion of shocks within each partition and $\sigma_{P}$ be the dispersion of shocks across partitions. Intuitively, how are these shocks identified? (Hint: think first about the responsiveness of labor supply conditional on a participation choice).
